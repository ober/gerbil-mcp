...
All 166 tests must pass before considering any change complete. The test suite covers:
...
- Function signature parameter names (source-level formals extraction, runtime keyword arg detection)
